...
app.get("/api/config", (_req, res) => {
  // Return public Firebase config. Values are sourced from Environment Variables.
  // Sensitive variables like Service Accounts must NEVER be returned here.
  res.json({
